...
eta1 = yscale * eta1_Vargaftik_and_Yargin(TK)
ax.plot(TK, eta1, label='Vargaftik, Yargin et al 1985', color=colors[0])
errors = eta1_Vargaftik_and_Yargin_error(TK)
...
eta1 = yscale * eta1_Vargaftik_1991_Table(TK)
...
### Saturated, data
eta_sat = yscale * eta_sat_Vargaftik_1991_Table(TK)
...
#eta_sat = yscale * extrapolation_of_V_91_low_pressure(TK)
#ax.plot(TK, eta_sat, color=color)
